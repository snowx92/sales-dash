        ...
        <div className="relative bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="absolute top-4 right-4 flex gap-2">
                <button
                    ...
                    title="Edit banner"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-[#9747FF]">
            ...
            <div className="p-4">
                <p className="text-sm text-gray-600 font-medium">Banner ID: {banner.id}</p>
            </div>
        </div>
    );
} 